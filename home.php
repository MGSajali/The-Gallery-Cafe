...
<section class="hero">
      ...
      <div class="swiper-wrapper">
         ...
         <div class="swiper-slide slide">
            <div class="content">
               <span>The Gallery Café</span>
               <h3>Enhance Your Dining Experience</h3>
...
<section class="category">
   ...
   <h1 class="title">Cuisine Types</h1>

   <div class="box-container">

   <a href="category.php?category=srilankan" class="box">
         <img src="images/srilankan.png" alt="">
         <h3>Sri Lankan</h3>
      </a>
      ...
      <a href="category.php?category=japanese" class="box">
         <img src="images/japanese.png" alt="">
         <h3>Japanese</h3>
      </a>

      <a href="category.php?category=indian" class="box">
